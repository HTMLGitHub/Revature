...
public class SecondServ extends HttpServlet {
	...
	//by default, since we didn't set any load-on-startup values for this servlet, it will default to LAZY initaliation
	@Override
    public void init()
    {
    	System.out.println("Second serv has been ititialized");
    }
